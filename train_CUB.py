...
import copy 
import json
from dataset_origin import LoadDataset as LoadDataset_origin
from dataset_origin import FeatDataLayer as FeatDataLayer_origin
from dataset import FeatDataLayer, LoadDataset, FeatDataLayer_add_FG
...
parser.add_argument('--family_lambda',  type=float, default=0.2)
parser.add_argument('--genus_lambda',  type=float, default=0.2)
...
def train():
    ...
    print("Accuracy is {:.4}%, and Generalized AUC is {:.4}%".format(result.best_acc, result_gzsl.best_auc * 100))
